# osapiens Bug Bounty Challenge - Work Log

This document summarizes the changes implemented during the bug-bounty exercises, plus tooling upgrades (Node/React, linting, tests, hooks).
